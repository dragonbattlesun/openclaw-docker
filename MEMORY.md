...
- [Chanlun 108 core rules](memory/reference_chanlun_108_core_rules.md): 学习本地《缠中说禅教你炒股票108课》PDF 后固化的原文结构口径;置顶“市场哲学的数学原理”:人性自相似 -> 走势自同构 -> 级别自组织 -> 买卖点可证伪,并覆盖级别、分型/笔/线段、中枢、三类买卖点、背驰、小转大、同级别分解、走势必完美、左侧买点边界、板块强弱和短线反弹。
