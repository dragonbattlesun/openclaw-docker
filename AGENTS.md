...
用户要求“写进规则 / 整理笔记 / 记住教训”时,必须按 `memory/reference_agent_note_writing_sop.md` 处理:
...
**强制核心规则**:以后所有涉及缠论的分析、选股、持仓诊断、买卖点判断、换仓决策,必须遵守 `/Users/dragonbattlesun/.codex/memories/chanlun/chanlun_108_core_rules.md`;仓库内同步参考为 `memory/reference_chanlun_108_core_rules.md`。若本段摘要与 `chanlun_108_core_rules.md` 的细则冲突,以 `chanlun_108_core_rules.md` 为准。
